    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblDealer", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileNumberPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblEmailSetup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblMenu", x => x.ControlId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblScheduleJob", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblDiscountPolicy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblDiscountPolicy_tblCategory_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tblProduct_tblCategory_CatId",
                        column: x => x.CatId,
                        principalTable: "tblCategory",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoleClaims_tblRole_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tblPermission_tblMenu_ControlId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_tblRole_RoleId",
                        column: x => x.RoleId,
                        principalTable: "tblRole",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "tblDiscountPolicyLine",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DiscountPolicyId = table.Column<int>(type: "int", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DealerId = table.Column<int>(type: "int", nullable: true),
                    Amount = table.Column<double>(type: "float", nullable: true),
                    DealerShare = table.Column<double>(type: "float", nullable: true),
                    CompanyShare = table.Column<double>(type: "float", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblDiscountPolicyLine", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tblDiscountPolicyLine_tblDealer_DealerId",
                        column: x => x.DealerId,
                        principalTable: "tblDealer",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_tblDiscountPolicyLine_tblDiscountPolicy_DiscountPolicyId",
                        column: x => x.DiscountPolicyId,
                        principalTable: "tblDiscountPolicy",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_tblDiscountPolicyLine_tblProduct_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblDiscountPolicy_CategoryId",
                table: "tblDiscountPolicy",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_tblDiscountPolicyLine_DealerId",
                table: "tblDiscountPolicyLine",
                column: "DealerId");

            migrationBuilder.CreateIndex(
                name: "IX_tblDiscountPolicyLine_DiscountPolicyId",
                table: "tblDiscountPolicyLine",
                column: "DiscountPolicyId");

            migrationBuilder.CreateIndex(
                name: "IX_tblDiscountPolicyLine_ProductId",
                table: "tblDiscountPolicyLine",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_tblPermission_ControlId",
                table: "tblPermission",
                column: "ControlId");
