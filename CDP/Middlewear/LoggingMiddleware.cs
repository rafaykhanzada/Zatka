...
namespace CDP.Middlewear
{
    public class LoggingMiddleware
    {
        ...
        //        if (route == "discountpolicy" || route == "redemption"|| route == "scan" && httpContext.Request.Method != "GET")
        //        {
        ...
        //            {
        //                tok = await reader.ReadToEndAsync();
        //                httpContext.Request.Body.Position = 0; // Reset the stream position for further use
        //            }
